...
//#region node_modules/@ionic/core/components/ios.transition.js
/*!
* (C) Ionic http://ionicframework.com - MIT License
*/
var ios_transition_exports = /* @__PURE__ */ __exportAll({
	...
	try {
		...
		enteringToolBarEls.forEach((enteringToolBarEl) => {
			...
			if (backDirection) {
				...
				if (!(parentHeader === null || parentHeader === void 0 ? void 0 : parentHeader.translucent)) enteringToolBarBg.fromTo(OPACITY, .01, "var(--opacity)");
		...
		if (leavingEl) {
			...
			leavingToolBarEls.forEach((leavingToolBarEl) => {
				...
				if (backDirection) {
					...
					if (!(parentHeader === null || parentHeader === void 0 ? void 0 : parentHeader.translucent)) leavingToolBarBg.fromTo(OPACITY, "var(--opacity)", 0);
...
//#endregion
export { ios_transition_exports as n, iosTransitionAnimation as t };

//# sourceMappingURL=ios.transition-DuHVEmfq.js.map